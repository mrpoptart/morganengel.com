export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-16 text-center animate-fade-in-up">
      {/* Avatar placeholder */}
      <div className="w-24 h-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-4 mx-auto bg-base-300 flex items-center justify-center">
        <span className="text-3xl font-mono font-bold text-primary">M</span>
      </div>
